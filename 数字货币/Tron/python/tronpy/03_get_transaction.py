...
def write_json(data, filename='get_transaction.json'):
...
def main():
    write_json(json.dumps(client.get_transaction('661f1df88ce02b746efe7449c3c7a04d6d21a7fc019723c92679228d8275ad57')), 'get_transaction_661f1df88ce02b746efe7449c3c7a04d6d21a7fc019723c92679228d8275ad57.json')
